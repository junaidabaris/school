...
function AdmitCardTemplateList() {
    return <div>
                                ...
                                <div className="dt-action-buttons text-xl-end text-lg-start text-md-end text-start d-flex align-items-center justify-content-end flex-md-row flex-column mb-3 mb-md-0">
                                    ...
                                    <div className="dt-buttons btn-group flex-wrap">
                                        ...
                                        <Link
                                            ...
                                            to={'/admin/AdmitCardTemplateAdd'}
                                        >
                                            <span>
                                                <i className="ti ti-plus me-0 me-sm-1 ti-xs" />
                                                <span className="d-none d-sm-inline-block">Add Admit Card Template</span>
                                            </span>
                                        </Link>
                                    </div>
                                </div>
                        ...
                        >
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>First Term Exam Admit Card	</td>
                                    <td>Width 210mm x Height 297mm	</td>
                                    <td>  -</td>
                                    <td>  18.May.2022	</td>
                                    <td>  
                                    <EditIcon />
...
export default AdmitCardTemplateList