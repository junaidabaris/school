                ...
                <div className="app-ecommerce">
                    ...
                    <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
                        <div className="d-flex flex-column justify-content-center">
                            <h4 className="mb-1 mt-3">Add Id Card</h4>
                        </div>
                        ...
                        <div className="col-12 col-lg-12" >
                            ...
                            <div className="card mb-4" style={{ padding: "10px" }}>
                                ...
                                <form className="row">
                                    ...
                                    <div className="form-group col-4">
                                        <label htmlFor="academicYear">Id Card Name</label>
                                        <input type="text" className="form-control" id="academicYear" />
                                    </div>
                                    <div className="form-group col-4">
                                        <label htmlFor="category">Applicable User</label>
                                        <select className="form-select" aria-label="Default select example">
                                            <option selected>Open this select menu</option>
                                            <option value="1">One</option>
                                            <option value="2">Two</option>
